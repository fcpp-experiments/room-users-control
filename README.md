...
Experimental evaluation of the case study on users' control of a room. This project consists of a single *graphic* simulation.
...
In order to execute the simulation, type the following command in a terminal:
```
